module Map
    class Room
      ...
      def initialize(name, description, options=false)
        @name = name
    ...
    interference. You get to the chamber with two escape pods, and
    ...
    """
    You shot the Gothon, but didn't do much damage. The Gothon's
    laser fries a hole through you!
    ...
    """
    You jump sideways trying to dodge, but this Gothon is the quickest
    draw in space. He zaps you with his laser as you fall to the ground.
    ...
    """
    You throw the bomb at the Gothons, hitting one of them. It explodes
    on impact, annihilating the ship and everyone on-board.
    ...
    """
    You entered the wrong passcode too many times and the door has now
    permanently locked behind a plasma field. You have nowhere to escape
    as the bomb ticks down.
